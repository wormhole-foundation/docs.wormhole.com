...
- [Etherscan](https://basescan.org/) | [Blockscout](https://base.blockscout.com/)
...
{% hint style='info' %}
Sepolia is a testnet only chain and can be used as an alternative to Ethereum Holesky
{% endhint %}
{% hint style='info' %}
...
{% hint style='info' %}
Holesky is a testnet only chain and can be used as an alternative to Sepolia
{% endhint %}
{% hint style='info' %}
